...
if (selected == 'Brain Stroke Prediction'):
    ...
    with col1:
        Heart_disease = st.text_input('Heart Disease (0 or 1)')

    with col2:
        Ever_married = st.selectbox('Have you ever married?', ('Yes', 'No'))
    ...
    with col2:
        Average_glucose_level = st.text_input('Average Glucose Level')
